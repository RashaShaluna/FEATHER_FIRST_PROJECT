...
adminRouter.get(
  "/unblockCustomer",
  adminAuth.isAdmin,
  customerController.customerUnBlock
);
...
adminRouter.post(
  ...
  productController.productAdding
);
adminRouter.get(
  "/outstock",
  adminAuth.isAdmin,
  productController.outstockProduct
);
adminRouter.get(
  "/instock",
  adminAuth.isAdmin,
  productController.instockProduct
);
adminRouter.get(
  "/blockproduct",
  adminAuth.isAdmin,
...
adminRouter.get(
  "/offerdeactive",
  adminAuth.isAdmin,
  offerController.offerDeactive
);
adminRouter.get("/offeractive", adminAuth.isAdmin, offerController.offerActive);
adminRouter.get(
  "/offerCategoryDeactive",
  adminAuth.isAdmin,
  offerController.offerCategoryDeactive
);
adminRouter.get(
  "/offerCategoryActive",
  adminAuth.isAdmin,
  offerController.offerCategoryActive
);
